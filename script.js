let groups = [
  ...
  ['E', ['España', 'Nueva Zelanda', 'Alemania', 'Japón']],
...
function handleSubmit(event) {
  ...
  for (let td of tds) {
    ...
    // let repechaje1 = document.getElementById("repechaje1")
    // if (golesLocal > golesVisitante) repechaje1 = "Perú";
    // else (golesLocal < golesVisitante) repechaje1 = "Australia";
